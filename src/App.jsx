    ...
    <div style={pageStyle}>
      ...
      <section style={heroStyle}>
        ...
        <p style={heroTextStyle}>
          Proper courier support for medical, commercial, legal, and time-sensitive logistics needs throughout South Jersey and the Philadelphia region.
        </p>
      ...
      <section id="services" style={sectionStyle}>
        ...
        <div style={cardsContainerStyle}>
          ...
          <div className="card" style={cardStyle}>
            <h4 style={cardTitleStyle}>Time-Sensitive & Overnight Logistics</h4>
            <p style={cardTextStyle}>
      ...
      <section id="capabilities" style={capabilitiesStyle}>
        ...
        <div style={capabilitiesGridStyle}>
          ...
          <div className="capability-item" style={capabilityItemStyle}>Time-Sensitive & Overnight Logistics</div>
      ...
      <section id="contact" style={contactSectionStyle}>
       ...
       <form
         ...
         style={formStyle}
         action="https://formspree.io/f/xlgzajpd"
         method="POST"
>
         ...
         <input type="text" name="phone" placeholder="Phone" style={inputStyle} />
         <input type="text" name="service" placeholder="Service Needed" style={inputStyle} />
